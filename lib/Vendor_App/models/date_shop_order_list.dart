...
//
//     final dateShopOrderListModel = dateShopOrderListModelFromJson(jsonString);

import 'dart:convert';

DateShopOrderListModel dateShopOrderListModelFromJson(String str) => DateShopOrderListModel.fromJson(json.decode(str));

String dateShopOrderListModelToJson(DateShopOrderListModel data) => json.encode(data.toJson());

class DateShopOrderListModel {
  String? result;
  String ?msg;
  dynamic data;
  ...
  factory DateShopOrderListModel.fromJson(Map<String, dynamic> json) => DateShopOrderListModel(
    result: json["result"]??"",
    msg: json["msg"]??"",
    data: json["data"]??""
  );
