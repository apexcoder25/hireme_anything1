...
class _FuneralCarHireServiceState extends State<FuneralCarHireService> {
  ...
  Widget _buildDatePicker(String label, Rx<DateTime> date, bool isFromDate, {bool allowFutureDates = true}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
          ...
          onTap: () async {
            ...
            if (pickedDate != null) {
              ...
              if (pickedTime != null) {
                ...
                if (allowFutureDates && newDateTime.isBefore(DateTime.now())) {
                  Get.snackbar(
                    "Invalid Date",
                ...
                if (!allowFutureDates && newDateTime.isAfter(DateTime.now())) {
                  Get.snackbar(
                    "Invalid Date",
                    "First registration date cannot be in the future.",
                    snackPosition: SnackPosition.BOTTOM,
                    backgroundColor: Colors.redAccent,
                    colorText: Colors.white,
                  );
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  _buildDatePicker(
                      'First Registration', firstRegistrationDate, true, allowFutureDates: false),
                  ...
                  Obx(() {
                    ...
                    return TableCalendar(
                      ...
                      firstDay: calendarController.fromDate.value != DateTime(1900) 
                        ? calendarController.fromDate.value 
                        : DateTime.now(),
                      lastDay: calendarController.toDate.value != DateTime(1900) 
                        ? calendarController.toDate.value 
                      ...
                      calendarBuilders: CalendarBuilders(
                        defaultBuilder: (context, day, focusedDay) {
                          ...
                          if (calendarController.fromDate.value != DateTime(1900) && 
                              calendarController.toDate.value != DateTime(1900)) {
                            isWithinRange = !day.isBefore(calendarController.fromDate.value) && 
                                           !day.isAfter(calendarController.toDate.value);
                          }
                          
                          if (isWithinRange && calendarController.visibleDates
  ...
  Widget _buildTermsCheckboxWithLink(String title, bool value, Function(bool) onChanged, String url) {
    return Container(
