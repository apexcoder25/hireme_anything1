      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Get.snackbar('Help', 'Edit your limo hire service details here.',
              ...
              child: Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildSectionCard(
                        title: 'SECTION 1: Service Category',
                        children: [
                          ...
                          if (controller.serviceCategories['Other']!.value) ...[
                            const SizedBox(height: 10),
                            Signup_textfilled(
                              length: 100,
                      ...
                      _buildSectionCard(
                        title: 'SECTION 2: Fleet / Vehicle Details',
                        children: [
                          const Text('(Complete one block per limousine model)', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w300, color: const Color.fromARGB(255, 109, 104, 104))),
                          const SizedBox(height: 10),
                      ...
                      _buildSectionCard(
                        title: 'SECTION 3: Features, Benefits & Extras',
                        children: [
                      ...
                      _buildSectionCard(
                        title: 'SECTION 4: Coverage & Availability',
                        children: [
                      ...
                      _buildSectionCard(
                        title: 'SECTION 5: Pricing Structure',
                        children: [
                          const Text('Each partner must offer a day hire rate (standard: 10 hours/100 miles)', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w300, color: const Color.fromARGB(255, 109, 104, 104))),
                          const SizedBox(height: 10),
                      ...
                      _buildSectionCard(
                        title: 'SECTION 6: Documents Required',
                        children: [
                          const Text('Upload scanned copies or clear photos', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w300, color: const Color.fromARGB(255, 109, 104, 104))),
                          const SizedBox(height: 10),
                      ...
                      _buildSectionCard(
                        title: 'SECTION 7: Photos & Media',
                        children: [
                          const Text('Upload ≥5 high-quality images (exterior front/back, interior, seating, feature shots)', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w300, color: const Color.fromARGB(255, 109, 104, 104))),
                          const SizedBox(height: 10),
                          ...
                          Obx(() => Padding(
                                ...
                                child: Center(
                                  child: Wrap(
                                    spacing: 8.0,
                                    runSpacing: 4.0,
                                    children: List.generate(controller.limousinePhotosPaths.length, (index) => Stack(
                                          children: [
                                            Image.network(
                                              controller.limousinePhotosPaths[index],
                                              fit: BoxFit.cover,
                                              height: 60,
                                              width: 60,
                                            ...
                                            Positioned(
                                              ...
                                              child: GestureDetector(
                                                onTap: () => controller.limousinePhotosPaths.removeAt(index),
                      ...
                      _buildSectionCard(
                        title: 'SECTION 8: Service Availability Period',
                        children: [
                          const Text('Select the period during which your service will be available.', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w300, color: const Color.fromARGB(255, 109, 104, 104))),
                          const SizedBox(height: 20),
                          Obx(() => _buildDatePicker(context, controller, "From", controller.fromDate, true)),
                          Obx(() => _buildDatePicker(context, controller, "To", controller.toDate, false)),
                          const SizedBox(height: 10),
                          Obx(() {
                            DateTime focusedDay = controller.fromDate.value;
                            if (focusedDay.isBefore(DateTime.now())) focusedDay = DateTime.now();
                            return TableCalendar(
                              ...
                              calendarBuilders: CalendarBuilders(
                                defaultBuilder: (context, day, focusedDay) {
                                  return controller.buildCalendarCell(day, controller.calendarController.visibleDates.any((d) => isSameDay(d, day)));
                                },
                              ),
                          ...
                          Obx(() => SizedBox(
                                ...
                                child: controller.calendarController.specialPrices.isEmpty
                                    ? Center(child: Text('No special prices set yet', style: TextStyle(fontSize: 16, color: Colors.black)))
                                    : ListView.builder(
                                        shrinkWrap: true,
                      ...
                      _buildSectionCard(
                        title: 'SECTION 9: Coupons / Discounts',
                        children: [
                      ...
                      _buildSectionCard(
                        title: 'SECTION 10: Declaration & Agreement',
                        children: [
                          CustomCheckbox(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () async {
            ...
            if (pickedDate != null) {
              final TimeOfDay? pickedTime = await showTimePicker(context: context, initialTime: TimeOfDay.fromDateTime(date.value));
              if (pickedTime != null) {
                final newDateTime = DateTime(pickedDate.year, pickedDate.month, pickedDate.day, pickedTime.hour, pickedTime.minute);
                if (newDateTime.isBefore(DateTime.now())) {
                  Get.snackbar("Invalid Date", "Please select a date and time in the future.", snackPosition: SnackPosition.BOTTOM, backgroundColor: Colors.redAccent, colorText: Colors.white);
                  return;
                }
                date.value = newDateTime;
                if (isFromDate) {
                  controller.calendarController.fromDate.value = date.value;
                  controller.calendarController.updateDateRange(controller.calendarController.fromDate.value, controller.calendarController.toDate.value);
                } else {
  ...
  Widget _buildDocumentUploadSection(BuildContext context, LimoHireEditController controller, String title, RxList<String> documentPaths, bool isRequired) {
    return Column(
      ...
      children: [
        ...
        Obx(() => Wrap(
              spacing: 8.0,
              children: List.generate(documentPaths.length, (index) => Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Stack(
                      children: [
                        Image.network(
