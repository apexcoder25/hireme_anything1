...
//           serviceNameController.text = service.listingTitle ?? 'Funeral Car Hire ${DateTime.now().year}';
...
//           // Fleet Details
//           makeModelController.text = service.fleetInfo?.makeAndModel ?? '';
//           yearController.text = service.fleetInfo?.year?.toString() ?? '';

//           // Safely parse seats from JSON since getter might be missing in the FleetInfo model
//           try {
//             final Map<String, dynamic>? fdJson =
//                 (service.fleetInfo as dynamic).toJson() as Map<String, dynamic>?;
